...
void UtilsSD::getContentDirSerial(char* dirIn, int numTabsIn) { // la fonction reçoit le nom du répertoire, le décalage tab et le drapeau de debug
  // La fonction reçoit : 
...
int UtilsSD::getNumberOfLines(char* nomFichierIn, boolean debug) {
  // La fonction reçoit : 
  ...
  // la fonction renvoie le nombre de ligne
   ...
   if (dataFileIn){ // le fichier est True si créé
      ...
      if (debug)Serial.println(F("Ouverture fichier OK")); 
...
// par X. HINAULT - www.mon-club-elec.fr -GPL v3 - 03/2013
 ...
 String UtilsSD::getLine(char* nomFichierIn, int lineNumberIn, boolean debug) { 
  // la fonctin reçoit : 
  // > le nom du fichier
  ...
  if (dataFileIn){ // le fichier est True si créé
      ...
      if (debug) Serial.println(F("ligne voulue : ")); 
      ...
      Serial.println(F("Probleme creation fichier")); 
    } // fin else
...
// par X. HINAULT - www.mon-club-elec.fr - GPLv3 - 03/2013
int UtilsSD::getFileSize(char* nomFichierIn, boolean debug) {
  // La fonction reçoit : 
  // > le nom du fichier au format 8.3
  // > un drapeau d'affichage de messages de debug
  ...
  // la fonction renvoie le nombre d'octet du fichier
   ...
   if (dataFileIn){ // le fichier est True si créé
      ...
      if (debug) Serial.print(F("Taille du fichier : "));
      if (debug) Serial.print(dataFileIn.size());
      if (debug) Serial.println(F(" octets."));
...
// par X. HINAULT - www.mon-club-elec.fr - GPLv3 - 03/2013
void UtilsSD::readSerial(char* nomFichierIn, boolean debug) {
  // La fonction reçoit : 
  // > le nom du fichier au format 8.3
  // > un drapeau d'affichage de messages de debug
  ...
  // la fonction ne renvoie rien 
                ...
                if (dataFile){ // le fichier est True si créé
                  ...
                  Serial.println(F("Probleme lecture fichier")); 
                } // fin else              
...
// par X. HINAULT - www.mon-club-elec.fr - GPLv3 - 03/2013
void UtilsSD::writeFile(char* nomFichierIn, String toWriteIn, boolean debug) {
  // La fonction reçoit : 
  // > le nom du fichier au format 8.3
  ...
  // la fonction ne renvoie rien 
              ...
              if (dataFile){ // le fichier est True si créé
                ...
                dataFile.close(); // fermeture du fichier obligatoire après accès 
                if(debug)Serial.println(F("Ecriture fichier OK")); 
              } // si fichier ==True 
              else { // sinon = si probleme creation
                Serial.println(F("Probleme ouverture fichier")); 
              } // fin else datafile
...
// par X. HINAULT - www.mon-club-elec.fr - GPLv3 - 03/2013
void UtilsSD::createFile(char* nomFichierIn, boolean debug) {
  // La fonction reçoit : 
  // > le nom du fichier au format 8.3
  // > un drapeau d'affichage de messages de debug
  ...
  // la fonction ne renvoie rien 
              ...
              if (dataFile){ // le fichier est True si créé
                Serial.println(F("Creation nouveau fichier OK")); 
